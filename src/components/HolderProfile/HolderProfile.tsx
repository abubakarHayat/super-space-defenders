        ...
        <div className="w-5/6 h-full relative m-auto">
          ...
          <div className="w-full absolute h-full top-0">
            <div className="flex  h-full  m-auto flex-col w-[90%] items-center justify-start lg:w-[80%]  xl:w-[75%] mt-3  md:mt-4">
              <h1 className="font-bugfast text-xl md:text-2xl mb-4">
                ACHIVEMENTS
              </h1>
        ...
        <div className="relative w-5/6 h-full">
          ...
          <div className="w-full absolute h-full top-0 flex justify-center">
            <div className="flex flex-col h-full w-4/5  items-center overflow-auto  scroll-bar">
              ...
              <p className="w-4/6 sm:w-full">
                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Autem
                quas aut libero atque tenetur nostrum. Perferendis harum
                voluptatibus asperiores sunt dignissimos molestias facere. Nemo
                quis fuga earum cumque enim, qui perferendis sint eligendi quia
                quasi sequi necessitatibus explicabo porro deleniti architecto
                assumenda hic, rerum quae ratione, ut magni dolore! Excepturi
                eius consequuntur, animi quis totam id optio dolorem beatae
                necessitatibus fugit expedita sapiente possimus incidunt natus
                temporibus ab sint adipisci nisi corporis. Porro autem modi
                necessitatibus itaque, consectetur eveniet praesentium delectus
                et molestias, explicabo voluptatum, ex vero. Repudiandae
                molestiae similique sunt commodi aspernatur error sapiente
                facilis? Quis dolorum cumque a!
              </p>
            </div>
          </div>
        </div>
