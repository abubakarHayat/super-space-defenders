...
import mintBtn from "../../../public/vector1.png";
import modalBg from "../../../public/vector6.png";
            ...
            <div className="mb-5 md:mb-2 2xl:mb-7 md:h-[95%] lg:h-auto 2xl:h-[95%] flex flex-col justify-between">
              <div>
                ...
                <p className="w-full mt-2 text-lg  md:text-xl lg:mt-6">
                  The Super Space Defenders is comprised of 4,444 hand-drawn 2D
                  avatars inspired by the 80s & 90s anime art style. This
                  collection has been meticulously crafted and organized to
                  represent a wide variety of aesthetics. Each Defender
                  possesses a unique combination of traits and rarities such as
                  origin, political affinity, hairstyles, etc., creating an
                  original character for every holder. The Super Space Defenders
                  come with exclusive holder rewards including but not limited
                  to:
                </p>
                <ol className="list-[square] ml-10 text-white text-lg   md:text-xl ">
                  <li className="mt-3 xl:mt-4 font-light">
                    Entry to exclusive community-focused events such as NFT
                    Drops, Lore Building Activities, and more!
                  </li>
                  <li className="mt-3 xl:mt-4 font-light">
                    Access to the Defenders Arcade.
                  </li>
                  <li className="mt-3 xl:mt-4 font-light">
                    Admission to participate in our upcoming Crafting System.
                  </li>
                  <li className="mt-3 xl:mt-4 font-light">
                    Ability to vote on future Web2 and Web3 proposals made by
                    the core team and community regarding the development and
                    growth of the Super Space Defenders.
                  </li>
                </ol>
              </div>
      ...
      {true && (
        <div className="flex justify-center z-30 relative">
          ...
          <div className="modal-content flex justify-start items-center flex-col overflow-hidden h-[40%] md:h-[43%] w-[90%] fixed top-[150px]  z-20 sm:w-3/4 md:w-[60%] lg:w-2/4 xl:w-[40%] 2xl:w-[30%]">
            ...
            <h1 className="font-bugfast text-2xl mt-10 min-w-max ">
              ...
              <div className="w-2/4 h-full flex flex-col items-center justify-between ">
                ...
                <div className=" w-full flex justify-between flex-col">
                  ...
                  <div className=" flex justify-center w-full h-[50%]">
                    ...
                    {/* <button
                      className="h-full w-2/4 mx-1 text-center text-white"
                      style={{
                        background: `url(${mintBtn.src})`,
                        backgroundSize: "cover",
