    ...
    >
      ...
      <div className="h-[90%] lg:h-[84%] 2xl:h-[86%] flex justify-center items-end">
        <Image
          ...
          width={200}
        />
        <div className="text-xl ml-16 sm:bottom-80 sm:mb-5 lg:ml-28 sm:ml-20 xl:bottom-96 2xl:mb-14 xl:mb-0 xl:ml-24 sm:text-2xl  2xl:ml-32 lg:text-3xl 2xl:text-4xl text-white  bottom-60 absolute">
          Plese insert a disk
        </div>
      </div>
    </div>
