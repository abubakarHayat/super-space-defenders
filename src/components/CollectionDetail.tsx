  ...
  return (
    ...
    >
      <div className=" w-12/12 h-4/5 flex justify-center items-center">
        <div className='w-4/5 h-4/5 mb-12 flex justify-end z-30'>

          <div className='lg:w-[75%] lg:2/4 bg-black bg-opacity-70 h-full overflow-y-scroll  scroll-bar flex flex-col justify-between'>
            <div className='h-full'>
              ...
              <div className="group-2 mt-9 mb-7 flex flex-col justify-center items-center space-x-8 md:flex-row 2xl:mt-16">
                <Image
            ...
            <p className='flex justify-center w-full text-xs md:text-sm xl:text-lg '>1035 COLLECTIBLES | 680 OWNERS | 26% UNIQUE OWNERS | 500 ETH TOTAL VOLUME</p>
          </div>
        </div>

      </div>

      <div className='md:w-4/6 absolute top-10 h-[100%] lg:ml-[2%] xl:ml-[4%] 2xl:ml-[6%] z-0'>
        <Image
          className='h-max z-0 '
